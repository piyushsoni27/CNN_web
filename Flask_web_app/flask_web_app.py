...
import os
import scipy.misc
import model_predict    #Module for predicting the class label of an input image.
import tensorflow
import cv2
    ...
    if(img.ndim) == 3:
        ...
        if img.shape[0] == img.shape[1] and img.shape[0] == 32:
            ...
            if img.shape[-1] == 3:
                ...
                """
                predicted_class = model_predict.main(sess, graph, img)
                """
...
if __name__ == "__main__":
    ...
    prepare_TF_session(saved_model_path='/media/piyush/New Volume/Projects/CNN_web/model/')
